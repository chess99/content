...
Codex 官方仓库已有对应的 Issue #35823，截至 2026 年 9 月 3 日仍处于开放状态。本文这套办法主要用于磁盘已经告急时应急回收空间；如果暂时没有空间压力，不必急着手工处理内部数据库，保持 Codex 更新并等待官方修复即可。
...
Codex Issue #35823：logs_2.sqlite 未回收空闲页
